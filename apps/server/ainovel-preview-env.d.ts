/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.ainovel-preview.jsonc ./src/ainovel-preview-env.d.ts` (hash: 55189492ff05f94f492b5737a990100e)
// Runtime types generated with workerd@1.20260721.1 2026-08-30 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	NODE_ENV: "preview";
	WEBSITE_URL: "https://ainovel-v2-preview.gt88hel.workers.dev";
	SERVER_URL: "https://ainovel-v2-preview-api.gt88hel.workers.dev";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./ainovel-preview");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "WEBSITE_URL" | "SERVER_URL">> {}
}
