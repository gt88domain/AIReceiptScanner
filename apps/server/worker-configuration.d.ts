/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings` (hash: e5ba0f6d4ecae9d12bca89a5f7a2f462)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "WEBSITE_URL" | "SERVER_URL" | "JOB_QUEUE_DLQ_NAME" | "GITHUB_CLIENT_ID" | "GOOGLE_CLIENT_ID" | "APPLE_APP_BUNDLE_IDENTIFIER" | "CONTROL_READ_HTTP_HOST" | "CONTROL_ACCESS_TEAM_DOMAIN" | "CONTROL_ACCESS_AUD" | "ADMIN_EMAILS" | "BETTER_AUTH_SECRET">> {}
}
