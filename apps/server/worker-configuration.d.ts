/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-interface=CloudflareBindings` (hash: 48c0ba9793ecc1d52a623f8a55a91f06)
// Runtime types generated with workerd@1.20260721.1 2026-07-14 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	WEBSITE_URL: "https://replace-domain.example";
	SERVER_URL: "https://api.replace-domain.example";
	JOB_QUEUE_DLQ_NAME: "replace-job-queue-dlq";
	GITHUB_CLIENT_ID: "";
	GOOGLE_CLIENT_ID: "";
	APPLE_APP_BUNDLE_IDENTIFIER: "";
	CONTROL_READ_HTTP_HOST: "";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "PAYMENTS_PRICE_ENV" | "WEBSITE_URL" | "SERVER_URL" | "JOB_QUEUE_DLQ_NAME" | "GITHUB_CLIENT_ID" | "GOOGLE_CLIENT_ID" | "APPLE_APP_BUNDLE_IDENTIFIER" | "CONTROL_READ_HTTP_HOST" | "CONTROL_ACCESS_TEAM_DOMAIN" | "CONTROL_ACCESS_AUD" | "ADMIN_EMAILS" | "BETTER_AUTH_SECRET">> {}
}
