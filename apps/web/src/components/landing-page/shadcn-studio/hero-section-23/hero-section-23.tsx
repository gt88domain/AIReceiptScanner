...
import CustomersCardSvg from "@/components/logos/svg/customers-card-svg";
import TotalSalesCard from "@/components/shadcn-studio/components/chart-total-sales";
import StatisticsCard from "@/components/shadcn-studio/components/statistics-card-03";
import RatingsCard from "@/components/shadcn-studio/components/statistics-card-04";
...
const HeroSection = ({ avatars }: { avatars?: AvatarList }) => {
  if (!avatars) {
  ...
  return (
    <section className="flex-1 overflow-hidden">
      <div className="mx-auto flex h-full max-w-7xl flex-col pt-24 pb-8 sm:pt-24 sm:pb-16 lg:pt-36 lg:pb-24">
            ...
            <div className="flex flex-col justify-center gap-6 max-xl:items-center max-xl:text-center md:max-xl:mx-auto md:max-xl:max-w-150">
              ...
              >
                <p className="text-muted-foreground text-xl">
                  Leverage intelligent analytics to track performance, compare trends, and stay
                  ahead with actionable business insights
                </p>
              </MotionPreset>
              <MotionPreset
                component="div"
