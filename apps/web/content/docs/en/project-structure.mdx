...
TanStack Template uses a **Turborepo** monorepo structure with **pnpm workspaces**.
...
├── optional/
│   └── mobile/        # Opt-in mobile (React Native + Expo)
└── docs/              # Documentation
```
...
The core workspace does not install or run this app. Install its optional
workspace only when the product needs mobile support.
